...
class TestBaseModelClassCreation(unittest.TestCase):
    ...
    def test_created_at_diff_updated_at(self):
        """
        Test difference between creation and updating time
        """
    ...
    def test_to_dict_method(self):
        ...
        self.assertEqual(dict_['__class__'], self.x.__class__.__name__)


class TestBaseModelObjectCreation(unittest.TestCase):
    """
    Test class for BaseModel instantiation with kwargs
    """
    ...
    def test_create_object_from_dict(self):
        ...
        self.assertIsInstance(self.my_new_model.created_at, datetime.datetime)
        self.assertIsInstance(self.my_new_model.updated_at, datetime.datetime)
